...
public class TestMoveSheep {
	...
	@Test
	public void noMoveSheep() throws RemoteException {
		...
		ServerMove testMove = new ServerMoveSheep(this.testStatus, sh3,
				this.mockedSender);
	...
	@Test
	public void testMoveSheep() throws RemoteException {
		...
		ServerMove testMove = new ServerMoveSheep(this.testStatus, sh1,
				this.mockedSender);
	...
	@Test
	public void testMoveSheepForced() throws RemoteException {
		...
		ServerMove testMove = new ServerMoveSheep(this.testStatus, sh2,
				this.mockedSender);
	...
	@Test
	public void testMoveBackSheep() throws RemoteException{
		...
		ServerMove move = new ServerMoveSheep(status, sh2, mockedSender);
	...
	@Test
	public void testForcedMoveBlackSheep() throws RemoteException{
